---
description: >-
  A downloadable AoM tool for defining and connecting the four North Star
  statements that guide a company, including tool notes and references.
icon: hammer
coverY: 0
layout:
  width: default
...
{% column width="75%" %}
{% content-ref url="../../layer-two-fundamentals/company-strategy/" %}
...
{% column width="75%" %}
{% content-ref url="../../layer-two-fundamentals/company-strategy/why/" %}
[why](../../layer-two-fundamentals/company-strategy/why/)
{% endcontent-ref %}
{% endcolumn %}
{% endcolumns %}
...
{% column width="75%" %}
{% content-ref url="../../layer-two-fundamentals/company-strategy/why/purpose.md" %}
[purpose.md](../../layer-two-fundamentals/company-strategy/why/purpose.md)
{% endcontent-ref %}

{% content-ref url="../../layer-two-fundamentals/company-strategy/why/vision.md" %}
[vision.md](../../layer-two-fundamentals/company-strategy/why/vision.md)
{% endcontent-ref %}

{% content-ref url="../../layer-two-fundamentals/company-strategy/why/mission.md" %}
[mission.md](../../layer-two-fundamentals/company-strategy/why/mission.md)
{% endcontent-ref %}

{% content-ref url="../../layer-two-fundamentals/company-strategy/why/values.md" %}
[values.md](../../layer-two-fundamentals/company-strategy/why/values.md)
{% endcontent-ref %}
{% endcolumn %}
{% endcolumns %}
